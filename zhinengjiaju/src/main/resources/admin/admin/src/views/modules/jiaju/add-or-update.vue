    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="家具编号" prop="jiajuUuidNumber">
                       <el-input v-model="ruleForm.jiajuUuidNumber"
                                 placeholder="家具编号" clearable  :readonly="ro.jiajuUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="家具编号" prop="jiajuUuidNumber">
                           <el-input v-model="ruleForm.jiajuUuidNumber"
                                     placeholder="家具编号" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="家具名称" prop="jiajuName">
                       <el-input v-model="ruleForm.jiajuName"
                                 placeholder="家具名称" clearable  :readonly="ro.jiajuName"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="家具名称" prop="jiajuName">
                           <el-input v-model="ruleForm.jiajuName"
                                     placeholder="家具名称" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="24">
                    <el-form-item class="upload" v-if="type!='info' && !ro.jiajuPhoto" label="家具照片" prop="jiajuPhoto">
                        <file-upload
                            tip="点击上传家具照片"
                            action="file/upload"
                            :limit="3"
                            :multiple="true"
                            :fileUrls="ruleForm.jiajuPhoto?ruleForm.jiajuPhoto:''"
                            @change="jiajuPhotoUploadChange"
                        ></file-upload>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.jiajuPhoto" label="家具照片" prop="jiajuPhoto">
                            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in (ruleForm.jiajuPhoto || '').split(',')" :src="item" width="100" height="100">
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="家具类型" prop="jiajuTypes">
                        <el-select v-model="ruleForm.jiajuTypes" :disabled="ro.jiajuTypes" placeholder="请选择家具类型">
                            <el-option
                                v-for="(item,index) in jiajuTypesOptions"
                    ...
                    <div v-else>
                        <el-form-item class="input" label="家具类型" prop="jiajuValue">
                        <el-input v-model="ruleForm.jiajuValue"
                            placeholder="家具类型" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="家具介绍" prop="jiajuContent">
                        <editor style="min-width: 200px; max-width: 600px;"
                                v-model="ruleForm.jiajuContent"
                                class="editor"
                                action="file/upload">
                        </editor>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.jiajuContent" label="家具介绍" prop="jiajuContent">
                            <span v-html="ruleForm.jiajuContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
    ...
    export default {
        data() {
            return {
                ...
                ruleForm: {
                    yonghuId: '',
                    jiajuUuidNumber: new Date().getTime(),
                    jiajuName: '',
                    jiajuPhoto: '',
                    jiajuTypes: '',
                    quyuTypes: '',
                ...
                rules: {
                   ...
                   jiajuUuidNumber: [
                              { required: true, message: '家具编号不能为空', trigger: 'blur' },
                          ],
                   jiajuName: [
                              { required: true, message: '家具名称不能为空', trigger: 'blur' },
                          ],
                   jiajuPhoto: [
                              { required: true, message: '家具照片不能为空', trigger: 'blur' },
                          ],
                   jiajuTypes: [
                   ...
                   jiajuContent: [
                              { required: true, message: '家具介绍不能为空', trigger: 'blur' },
                          ],
                   zhuangtaiTypes: [
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=jiaju_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.jiajuTypesOptions = data.data.list;
                    }
                });
                this.$http({
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`jiaju/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.jiajuCrossAddOrUpdateFlag = false;
                                        this.parent.search();
            ...
            //图片
            jiajuPhotoUploadChange(fileUrls){
                this.ruleForm.jiajuPhoto = fileUrls;
                this.addEditUploadStyleChange()
            },
