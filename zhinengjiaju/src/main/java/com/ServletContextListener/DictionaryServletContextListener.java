...
public class DictionaryServletContextListener implements ServletContextListener {
    ...
    public void contextInitialized(ServletContextEvent sce) {
        ...
        if (myThreadMethod == null) {
            ...
            RenwuService renwuService = (RenwuService)appContext.getBean("renwuService");
            JiajuService jiajuService = (JiajuService)appContext.getBean("jiajuService");
            myThreadMethod.setRenwuService(renwuService);
            myThreadMethod.setJiajuService(jiajuService);
